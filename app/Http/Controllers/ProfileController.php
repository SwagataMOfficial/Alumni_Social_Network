...
class ProfileController extends Controller {
    ...
    public function save_changes(Request $request) {
        ...
        if (isset($file)) {
            ...
            $request->file('cover_picture')->storeAs('/storage/', $filename, 'public');
        ...
        if (isset($file)) {
            ...
            $request->file('profile_picture')->storeAs('/storage/', $filename, 'public');
        ...
        if (isset($file)) {
            ...
            $request->file('verification_document')->storeAs('/storage/', $filename, 'public');
        ...
        if (isset($file)) {
            ...
            $request->file('resume')->storeAs('/storage/', $filename, 'public');
        ...
        // User::find(session()->get('user_id'))->update($updateArr);
