                    ...
                    <div class="bg-white rounded-full border-4 border-white">
                        ...
                        <a href="/profile/home/{{ $user['remember_token'] }}">
                            <img src="/storage/default/avatar.jpg" alt="Profile Picture"
                                class="md:h-16 md:w-16 lg:h-28 lg:w-28 rounded-full">
                        </a>
                    </div>
                </div>
                <div class="md:h-36 overflow-hidden rounded-lg">
                    <!-- Cover image  -->
                    <img src="{{ asset('images/temp/cover.jpg') }}" alt="">
                </div>
                <!-- Texts -->
        ...
        <div class="w-full md:w-1/3 lg:w-1/3 z-10">
            ...
            <div class="flex justify-center">
                <div class="inline-flex items-center justify-center p-4 bg-white rounded-full">
                    <!-- Profile picture -->
                    <div class="rounded-full bg-gray-300 h-12 w-12 flex items-center justify-center">
                        <a href="/profile/home/{{ $user['remember_token'] }}">
                            <img src="/storage/default/avatar.jpg" alt="image">
                        </a>
                    </div>
